...
موقع عربي لتسجيل الطلاب بالاسم ورقم الهاتف، ثم اختيار مجموعتين مختلفتين من ٧ مجموعات مسائية (الأحد إلى السبت، الساعة ٨:٠٠ مساءً، ٣٠ مقعداً لكل مجموعة).
...
إذا كان المشروع يعمل مسبقاً وتريد إلزام كل طالب بمجموعتين، شغّل [supabase/two-groups.sql](supabase/two-groups.sql) مرة واحدة في محرر SQL. لا تعِد تشغيل ملف schema.sql بالكامل.
